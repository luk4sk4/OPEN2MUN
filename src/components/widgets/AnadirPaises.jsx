...
import { Search, Users, Timer, Check, Plus, X, Crown, Sparkles, UserPlus } from 'lucide-react';
    ...
    <div style={{
            ...
            <div style={{ display: 'flex', gap: '0.3rem' }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: '0.7rem',
                  borderRadius: '4px',
                  border: filtroVista === 'EN_LISTA' ? '1px solid #71717a' : '1px solid transparent',
                  backgroundColor: filtroVista === 'EN_LISTA' ? '#27272a' : 'transparent',
                  color: filtroVista === 'EN_LISTA' ? '#d4d4d8' : '#71717a',
                  cursor: 'pointer',
                  fontWeight: filtroVista === 'EN_LISTA' ? '600' : '400'
                }}
              >
      ...
      <div style={{
        ...
        {paises.length === 0 ? (
          ...
          /* Grid de países con estado dinámico (Gris si está en cola, activo si está disponible) */
          <div style={{
            display: 'grid',
            ...
            {paisesFiltrados.map((pais) => {
              ...
              return (
                <div
                  ...
                  title={estaEnLista ? `${pais.nombre} (En lista #${posEnLista}) - Clic para retirar` : `${pais.nombre} - Clic para añadir a ${esGSL ? 'Lista General' : 'Debate'}`}
                  style={{
                    position: 'relative',
