...
const Open2MunLogo = ({ width = 180, height = 44, showText = true, isLight = false, className = '', style = {} }) => {
  ...
  return (
    <div
      className={`open2mun-logo-container ${className}`}
      style={{
        display: 'inline-flex',
        alignItems: 'center',
        gap: '0.65rem',
      ...
      {showText && (
        <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1 }}>
          <span style={{
            ...
            OPEN<span style={{ color: secondaryColor }}>2MUN</span>
          </span>
          <span style={{
            fontSize: '0.58rem',
            fontWeight: '700',
