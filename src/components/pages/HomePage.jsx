...
const HomePage = ({ onNavigateToComienzo, onNavigateToJoin, isLight }) => {
  ...
  return (
    <div style={{
      ...
      {/* ── 4. BLOC DE NOTAS RÁPIDO DE LA MESA ── */}
      <section style={{
        backgroundColor: surfaceBg,
        border: `1px solid ${borderColor}`,
        borderRadius: '14px',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '0.78rem', color: textMuted, margin: 0 }}>
                Anotaciones privadas guardadas localmente en este navegador.
              </p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            {notasGuardadasFlash && (
              <span style={{ fontSize: '0.78rem', color: '#22c55e', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
        ...
        {editandoNotas ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <textarea
              ...
              placeholder="Escribe recordatorios de sesión, puntos pendientes o agenda del día..."
              rows={4}
              style={{
                width: '100%',
          ...
          <div style={{
            ...
            {notasUsuario || <span style={{ color: textMuted, fontStyle: 'italic' }}>Sin notas añadidas. Haz clic en "Editar" para escribir anotaciones de la mesa...</span>}
          </div>
        )}
      </section>
